    ...
    <div className="mx-auto mt-0 mb-16 pb-10 relative max-w-[550px]">
      ...
      <a
        ...
        <svg fill="none" height="38" viewBox="0 0 35 38" width="35" xmlns="http://www.w3.org/2000/svg">
          <path
            className="stroke-font-dark dark:stroke-font-light group-hover:stroke-accent-light group-hover:dark:stroke-accent-dark transition-colors group-hover:text-accent-light dark:group-hover:text-accent-dark"
