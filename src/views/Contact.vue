            ...
            <ul class="footer__links">
                ...
                >
                    <a href="https://www.facebook.com/Teziovsky">
                        ...
                        >
                            <path
                                d="M0 0V36H36V0H0ZM24 10.5H21.1155C20.1915 10.5 19.5 10.878 19.5 11.8335V13.5H24L23.6415 18H19.5V30H15V18H12V13.5H15V10.6155C15 7.5825 16.596 6 20.1915 6H24V10.5Z"
                                fill="#D4D4DC"
                            />
                        </svg>
                    </a>
...
.form {
    ...
    &__input {
        ...
        &.title {
            background: url("../assets/inputs/Title_ico.svg") no-repeat scroll
                9px 11px;
            background-size: 23px 23px;
        }

        &.message {
            background: url("../assets/inputs/Message_ico.svg") no-repeat scroll
                11px 13px;
